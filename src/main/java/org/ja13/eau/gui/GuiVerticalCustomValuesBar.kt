...
class GuiVerticalCustomValuesBar(x: Int, y:Int, width: Int, height: Int, helper: org.ja13.eau.gui.GuiHelper,
                                 val positions: Array<Float>) :
    org.ja13.eau.gui.GuiVerticalTrackBar(x, y, width, height, helper) {
