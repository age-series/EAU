...
public abstract class GuiContainerEln extends GuiContainer implements IGuiObject.IGuiObjectObserver, GuiTextFieldElnObserver {
        ...
        for (Object o : inventorySlots.inventorySlots) {
            ...
            if (slot.getHasStack() == false
                ...
                if (slot instanceof ISlotWithComment) {
                    ...
                    if (!list.isEmpty())
                        drawHoveringText(list, mx - guiLeft + xOffset, my - guiTop, fontRendererObj);
                }
            }
        }
    }
