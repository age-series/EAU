...
import org.ja13.eau.sim.mna.SubSystem.Th;
...
public class TurbineElectricalProcess implements IProcess, IRootSystemPreStepProcess {
    ...
    public void process(double time) {
        ...
        SubSystem.Th th = turbine.positiveLoad.getSubSystem().getTh(turbine.positiveLoad, turbine.electricalPowerSourceProcess);
        double Ut;
        if (targetU < th.U) {
            Ut = th.U;
