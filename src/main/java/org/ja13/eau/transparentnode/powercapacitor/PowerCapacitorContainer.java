    ...
    public PowerCapacitorContainer(EntityPlayer player, IInventory inventory) {
        super(player, inventory, new Slot[]{
            new SlotFilter(inventory, redId, 132, 8, 13,
                ...
                ISlotSkin.SlotSkin.medium, new String[]{I18N.tr("Redstone slot"), I18N.tr("(Increases capacity)")}),
            new GenericItemUsingDamageSlot(inventory, dielectricId, 132 + 20, 8, 20,
                DielectricItem.class, ISlotSkin.SlotSkin.medium,
                new String[]{I18N.tr("Dielectric slot"), I18N.tr("(Increases maximal voltage)")})
