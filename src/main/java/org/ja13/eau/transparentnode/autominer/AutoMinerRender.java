...
import org.ja13.eau.item.electricalitem.PortableOreScannerItem.RenderStorage;
...
import org.ja13.eau.misc.PhysicalInterpolatorNoRebound;
...
public class AutoMinerRender extends TransparentNodeElementRender {
    ...
    private final PortableOreScannerItem.RenderStorage render = new PortableOreScannerItem.RenderStorage(EAU.autominerRange, 130, 24, 24);
