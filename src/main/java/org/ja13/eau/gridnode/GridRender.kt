...
abstract class GridRender(tileEntity: org.ja13.eau.node.transparent.TransparentNodeEntity, descriptor: org.ja13.eau.node.transparent.TransparentNodeDescriptor) : org.ja13.eau.node.transparent.TransparentNodeElementRender(tileEntity, descriptor) {
    ...
    init {
        ...
        cableTexture = ResourceLocation("eau", this.descriptor.cableTexture)
    }
    ...
    // ...later. Much later.
    (start: Vec3, end: Vec3) {
        val list: Int = glGenLists(1)

        val origin = Vec3.createVectorHelper(0.0, 0.0, 0.0)
        val box = intArrayOf(3, 7, 5, 3, 5, 1, 4, 8, 6, 4, 6, 2, 1, 6, 5, 1, 2, 6, 3, 8, 7, 3, 4, 8)
        // Maps box coordinates (above) to texture coordinates.
        val boxTex = intArrayOf(0, 0, // 1
                0, 1, // 2
                0, 1, // 3
                0, 0, // 4
                1, 0, // 5
        ...
        fun multiply(a: Vec3, b: Double): Vec3 {
