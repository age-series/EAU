...
abstract class GridElement(transparentNode: org.ja13.eau.node.transparent.TransparentNode, descriptor: org.ja13.eau.node.transparent.TransparentNodeDescriptor, internal var connectRange: Int) : org.ja13.eau.node.transparent.TransparentNodeElement(transparentNode, descriptor) {
    ...
    override fun onBlockActivated(entityPlayer: EntityPlayer, side: Direction, vx: Float, vy: Float, vz: Float): Boolean {
        ...
        if (itemDesc is org.ja13.eau.sixnode.genericcable.GenericCableDescriptor) {
    ...
    private fun onTryGridConnect(entityPlayer: EntityPlayer, stack: ItemStack, cable: org.ja13.eau.sixnode.genericcable.GenericCableDescriptor, side: Direction): Boolean {
    ...
    abstract fun getGridElectricalLoad(side: Direction): org.ja13.eau.sim.ElectricalLoad?
