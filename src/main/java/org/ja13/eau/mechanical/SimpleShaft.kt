...
abstract class SimpleShaftDescriptor(name: String, elm: KClass<out org.ja13.eau.node.transparent.TransparentNodeElement>, render: KClass<out org.ja13.eau.node.transparent.TransparentNodeElementRender>, tag: org.ja13.eau.node.transparent.EntityMetaTag) :
    org.ja13.eau.node.transparent.TransparentNodeDescriptor(name, elm.java, render.java, tag) {

    abstract val obj: org.ja13.eau.misc.Obj3D
    abstract val static: Array<out org.ja13.eau.misc.Obj3D.Obj3DPart>
    abstract val rotating: Array<out org.ja13.eau.misc.Obj3D.Obj3DPart>
...
open class ShaftRender(entity: org.ja13.eau.node.transparent.TransparentNodeEntity, desc: org.ja13.eau.node.transparent.TransparentNodeDescriptor) : org.ja13.eau.node.transparent.TransparentNodeElementRender(entity, desc) {
    ...
    open val cableRender: org.ja13.eau.cable.CableRenderDescriptor? = null
...
abstract class SimpleShaftElement(node: org.ja13.eau.node.transparent.TransparentNode, desc_: org.ja13.eau.node.transparent.TransparentNodeDescriptor) :
    org.ja13.eau.node.transparent.TransparentNodeElement(node, desc_), ShaftElement {
