...
class VerticalHubDescriptor(baseName: String, obj: org.ja13.eau.misc.Obj3D):
...
class VerticalHubElement(node: org.ja13.eau.node.transparent.TransparentNode, desc_: org.ja13.eau.node.transparent.TransparentNodeDescriptor):
...
class VerticalHubRender(entity: org.ja13.eau.node.transparent.TransparentNodeEntity, desc: org.ja13.eau.node.transparent.TransparentNodeDescriptor):
