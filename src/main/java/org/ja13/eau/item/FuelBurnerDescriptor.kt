...
class FuelBurnerDescriptor(name: String, val producedHeatPower: Double, val type: Int, val soundPitch: Float) :
    ...
    companion object {
        ...
        fun getDescriptor(itemStack: ItemStack?) =
            (itemStack?.item as? org.ja13.eau.generic.GenericItemUsingDamage<*>)?.getDescriptor(itemStack) as? FuelBurnerDescriptor
    }
    ...
    override fun addInformation(itemStack: ItemStack?, entityPlayer: EntityPlayer?, list: MutableList<String>, par4: Boolean) {
        ...
        list.add(org.ja13.eau.i18n.I18N.tr("Burn unit for the gas heat furnace."))
        list.add(Utils.plotPower(producedHeatPower, org.ja13.eau.i18n.I18N.tr("Produced heat power:")))
    }
}
