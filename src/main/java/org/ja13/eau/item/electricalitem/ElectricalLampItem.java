...
public class ElectricalLampItem extends LampItem implements IItemEnergyBattery {
    ...
    public ElectricalLampItem(String name, int lightMin, int rangeMin, double dischargeMin, int lightMax,
		...
		boosted = new ResourceLocation("eau", "textures/items/" + name.replace(" ", "").toLowerCase() + "boosted.png");
    ...
    public ItemStack onItemRightClick(ItemStack s, World w, EntityPlayer p) {
        if (!w.isRemote) {
            ...
            switch (lightState) {
                case 0:
                    Utils.addChatMessage(p, "flashlight OFF");
                    break;
                case 1:
                    Utils.addChatMessage(p, "flashlight ON");
                    break;
                case 2:
                    Utils.addChatMessage(p, "flashlight BOOSTED");
                    break;
                default:
                    break;
            }
    ...
    public void addInformation(ItemStack itemStack, EntityPlayer entityPlayer, List list, boolean par4) {
        ...
        if (itemStack != null) {
            ...
            list.add(I18N.tr("State:") + " " + (getLightState(itemStack) != 0 ? I18N.tr("On") : I18N.tr("Off")));
        }
    }
/*
	@Override
