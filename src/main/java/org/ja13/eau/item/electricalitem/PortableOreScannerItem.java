...
import org.ja13.eau.server.PlayerManager.PlayerMetadata;
...
public class PortableOreScannerItem extends GenericItemUsingDamageDescriptor implements IItemEnergyBattery {
    ...
    Obj3DPart textInit;
    Obj3DPart buttons;
    Obj3DPart[] screenDamage;
    Obj3DPart screenLuma;
    ...
    public void onUpdate(ItemStack stack, World world, Entity entity, int par4, boolean par5) {
        ...
        PlayerMetadata playerData = EAU.playerManager.get((EntityPlayerMP) entity);
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        if (drawRay) {
            ...
            Object oRender = EAU.clientLiveDataManager.getData(item, 1);
            if (oRender == null)
                oRender = EAU.clientLiveDataManager.newData(item, new RenderStorage(viewRange, viewYAlpha, resWidth, resHeight), 1);
    ...
    public static class RenderStorage {
        ...
        public static float[] getBlockKeyFactor() {
            ...
            for (OreScannerConfigElement c : EAU.oreScannerConfig) {
            ...
            for (int screenY = 0; screenY < resHeight; screenY++) {
                ...
                for (int screenX = 0; screenX < resWidth; screenX++) {
                    ...
                    while (d < viewRange) {
                        ...
                        if (b != Blocks.air && b != EAU.lightBlock) {
                            if (b.isOpaqueCube())
