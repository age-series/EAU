 ...
 */
object I18N {
    private val languageRegistry = LanguageRegistry.instance()
    @JvmStatic
    val currentLanguage: String
        get() = FMLCommonHandler.instance().currentLanguage

    @JvmOverloads
    fun encodeLangKey(key: String, replaceWhitspaces: Boolean = true): String {
        var lkey = key
    ...
    fun tr(text: String, vararg objects: Any): String {
        ...
        var translation = languageRegistry.getStringLocalization(encodeLangKey(text))
    ...
    enum class Type(
         ...
         */
        BLOCK("block.", false, false), SIX_NODE("eau.sixnode.", false, true), NODE("eau.node.", false, true);
    }
}
