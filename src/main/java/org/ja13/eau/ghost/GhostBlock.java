...
public class GhostBlock extends Block {
    ...
    public void addCollisionBoxesToList(World world, int x, int y, int z, AxisAlignedBB par5AxisAlignedBB, List list, Entity entity) {
        ...
        switch (meta) {
            case tFloor:
                AxisAlignedBB axisalignedbb1 = AxisAlignedBB.getBoundingBox(x, y, z, (double) x + 1, (double) y + 0.0625, (double) z + 1);
    ...
    public AxisAlignedBB getSelectedBoundingBoxFromPool(World w, int x, int y, int z) {
        ...
        switch (meta) {
            case tFloor:
                return AxisAlignedBB.getBoundingBox(x, y, z, (double) x + 1, (double) y + 0.0625, (double) z + 1);
            case tLadder:
                return AxisAlignedBB.getBoundingBox(x, y, z, (double) x + 0, (double) y + 0.0, (double) z + 0);
            default:
    ...
    GhostElement getElement(World world, int x, int y, int z) {
        return EAU.ghostManager.getGhost(new Coordonate(x, y, z, world));
    }
