...
import org.ja13.eau.node.NodeBlock;
...
public class SixNodeBlock extends NodeBlock {
    ...
    public void registerBlockIcons(IIconRegister r) {
        ...
        this.blockIcon = r.registerIcon("eau:air");
    }
    ...
    public void getSubBlocks(Item par1, CreativeTabs tab, List subItems) {
		 ...
		 */
        EAU.sixNodeItem.getSubItems(par1, tab, subItems);
    }
    ...
    public AxisAlignedBB getSelectedBoundingBoxFromPool(World w, int x, int y, int z) {
        ...
        if (col != null) {
            ...
            switch (Direction.fromIntMinecraftSide(col.sideHit)) {
                case XN:
                    return AxisAlignedBB.getBoundingBox((double) x + b, y, z, (double) x + h, (double) y + 1, (double) z + 1);
                case XP:
                    return AxisAlignedBB.getBoundingBox((double) x + hn, y, z, (double) x + bn, (double) y + 1, (double) z + 1);
                case YN:
                    return AxisAlignedBB.getBoundingBox(x, (double) y + b, z, (double) x + 1, (double) y + h, (double) z + 1);
                case YP:
                    return AxisAlignedBB.getBoundingBox(x, (double) y + hn, z, (double) x + 1, (double) y + bn, (double) z + 1);
                case ZN:
                    return AxisAlignedBB.getBoundingBox(x, y, (double) z + b, (double) x + 1, (double) y + 1, (double) z + h);
                case ZP:
                    return AxisAlignedBB.getBoundingBox(x, y, (double) z + hn, (double) x + 1, (double) y + 1, (double) z + bn);
