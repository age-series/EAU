...
import org.ja13.eau.misc.FakeSideInventory;
...
public class TransparentNodeEntity extends NodeBlockEntity implements ISidedInventory { // boolean[] syncronizedSideEnable = new boolean[6];
    public TransparentNodeElementRender elementRender = null;
        ...
        try {
            ...
            if (id == 0) {
                ...
                if (id != elementRenderId) {
                    elementRenderId = id;
                    TransparentNodeDescriptor descriptor = EAU.transparentNodeItem.getDescriptor(id);
