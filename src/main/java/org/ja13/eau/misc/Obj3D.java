...
public class Obj3D {
    ...
    public void bindTexture(String texFilename) {
        ResourceLocation textureResource = new ResourceLocation("eau", "model/" + dirPath + "/" + texFilename);
    ...
    public ResourceLocation getModelResourceLocation(String name) {
        return new ResourceLocation("eau", "model/" + dirPath + "/" + name);
    }
    ...
    private BufferedReader getResourceAsStream(String filePath, boolean trySource) {
        ...
        final String path = "assets/eau/" + filePath;
        try {
