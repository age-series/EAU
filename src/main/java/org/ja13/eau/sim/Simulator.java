...
import org.ja13.eau.sim.process.destruct.IDestructable;
...
public class Simulator /* ,IPacketHandler */ {
    ...
    private final ArrayList<IProcess> slowProcessList;
    private final List<IProcess> slowPreProcessList;
    private final List<IProcess> slowPostProcessList;

    private final ArrayList<IProcess> electricalProcessList;

    private final ArrayList<IProcess> thermalFastProcessList;
    private final ArrayList<IProcess> thermalSlowProcessList;
    private final ArrayList<ThermalConnection> thermalFastConnectionList;
    private final ArrayList<ThermalConnection> thermalSlowConnectionList;
    private final ArrayList<ThermalLoad> thermalFastLoadList;
    private final ArrayList<ThermalLoad> thermalSlowLoadList;
    private final Set<IDestructable> destructableSet;
