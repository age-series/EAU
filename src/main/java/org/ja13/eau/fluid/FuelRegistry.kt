...
object FuelRegistry {
    ...
    private val steam = mapOf(
        ...
        it.value / org.ja13.eau.EAU.fuelHeatValueFactor
    }
    ...
    fun heatEnergyPerMilliBucket(fuelName: String): Double = org.ja13.eau.EAU.fuelHeatValueFactor * (allFuels[fuelName] ?: 0.0)
