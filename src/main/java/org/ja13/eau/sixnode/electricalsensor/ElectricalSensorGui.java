...
public class ElectricalSensorGui extends GuiContainerEln {
    ...
    public void initGui() {
        ...
        if (!render.descriptor.voltageOnly) {
            voltageType = newGuiButton(8, 8, 50, I18N.tr("Voltage"));
            currentType = newGuiButton(8, 8 + 24, 50, I18N.tr("Current"));
            powerType = newGuiButton(8, 8 + 48, 50, I18N.tr("Power"));
            dirType = newGuiButton(8 + 50 + 4, 8 + 48, 50, "");

            int x = 0, y = -12;
            validate = newGuiButton(x + 8 + 50 + 4 + 50 + 4, y + (166 - 84) / 2 - 9, 50, I18N.tr("Validate"));
            ...
            validate = newGuiButton(8 + 50 + 4, 10, 50, I18N.tr("Validate"));

            lowValue = newGuiTextField(8, 6 + 16, 50);
            lowValue.setText(render.lowValue);
            lowValue.setComment(I18N.tr("Measured voltage\ncorresponding\nto 0% output").split("\n"));

            highValue = newGuiTextField(8, 6, 50);
            highValue.setText(render.highValue);
            highValue.setComment(I18N.tr("Measured voltage\ncorresponding\nto 100% output").split("\n"));
        }
    }
