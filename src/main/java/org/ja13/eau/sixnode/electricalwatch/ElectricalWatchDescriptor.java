...
public class ElectricalWatchDescriptor extends SixNodeDescriptor {
    ...
    private Obj3D.Obj3DPart base, cHour, cMin; //Analog
    private final Obj3D.Obj3DPart[] digits = new Obj3D.Obj3DPart[4]; //Digital
    private Obj3D.Obj3DPart dot, glass; //Digital
    ...
    public void addInfo(@NotNull ItemStack itemStack, @NotNull EntityPlayer entityPlayer, @NotNull List<String> list) {
        ...
        list.add(I18N.tr("Tells the time."));
        list.add(I18N.tr("Requires batteries for operation."));
    }
