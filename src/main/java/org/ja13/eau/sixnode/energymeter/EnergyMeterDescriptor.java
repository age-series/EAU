...
public class EnergyMeterDescriptor extends SixNodeDescriptor {
    ...
    public Obj3D.Obj3DPart base, powerDisk, energySignWheel, timeUnitWheel, energyUnitWheel;
    public Obj3D.Obj3DPart[] energyNumberWheel, timeNumberWheel;
    ...
    public EnergyMeterDescriptor(String name, Obj3D obj, int energyWheelCount, int timeWheelCount) {
        ...
        if (obj != null) {
            ...
            energyNumberWheel = new Obj3D.Obj3DPart[energyWheelCount];
            for (int idx = 0; idx < energyNumberWheel.length; idx++) {
                energyNumberWheel[idx] = obj.getPart("EnergyNumberWheel" + idx);
            }
            timeNumberWheel = new Obj3D.Obj3DPart[timeWheelCount];
