...
import org.ja13.eau.sixnode.electricalwatch.ElectricalWatchContainer;
...
import static org.ja13.eau.misc.Direction.*;
import static org.ja13.eau.misc.Direction.XP;
...
public class ElectricalFireDetectorSlowProcess implements IProcess {
    ...
    public void process(double time) {
        if (element.descriptor.batteryPowered) {
            ...
            BatteryItem battery = (BatteryItem) BatteryItem.getDescriptor(batteryStack);
            double energy;
            if (battery == null || (energy = battery.getEnergy(batteryStack)) < ElectricalFireDetectorDescriptor.PowerComsumption * time * 4) {
