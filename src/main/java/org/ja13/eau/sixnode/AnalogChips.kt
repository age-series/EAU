...
import org.ja13.eau.gui.GuiVerticalCustomValuesBar
...
import org.ja13.eau.sixnode.SummingUnitElement.Companion.GainChangedEvents
...
open class AnalogChipDescriptor(name: String, obj: org.ja13.eau.misc.Obj3D?, functionName: String,
    ...
    constructor(name: String, obj: org.ja13.eau.misc.Obj3D?, functionName: String, functionClass: Class<out AnalogFunction>) :
...
open class AnalogChipElement(node: org.ja13.eau.node.six.SixNode, side: Direction, sixNodeDescriptor: org.ja13.eau.node.six.SixNodeDescriptor) :
    ...
    init {
        ...
        electricalProcessList.add(org.ja13.eau.sim.IProcess { time: Double ->
    ...
    override fun multiMeterString(): String? {
        ...
        builder.append(org.ja13.eau.i18n.I18N.tr(" O: ")).append(if (outputProcess.u == 50.0) "1" else "0")
...
open class AnalogChipRender(entity: org.ja13.eau.node.six.SixNodeEntity, side: Direction, descriptor: org.ja13.eau.node.six.SixNodeDescriptor) :
...
class PIDRegulator : AnalogFunction() {
    ...
    override fun readFromNBT(nbt: NBTTagCompound, str: String) {
        ...
        Ki = nbt.getDouble("Ki")
        Kd = nbt.getDouble("Kd")
        errorIntegral = nbt.getDouble("errorIntegral")
    }
    ...
    override fun getWaila(inputs: Array<Double?>, output: Double): MutableMap<String, String> {
        ...
        info[org.ja13.eau.i18n.I18N.tr("Params")] = "Kp = $Kp, Ki = $Ki, Kd = $Kd"
        return info
    }
}

class PIDRegulatorElement(node: org.ja13.eau.node.six.SixNode, side: Direction, sixNodeDescriptor: org.ja13.eau.node.six.SixNodeDescriptor) :
    AnalogChipElement(node, side, sixNodeDescriptor), org.ja13.eau.item.IConfigurable {
    companion object {
...
class PIDRegulatorRender(entity: org.ja13.eau.node.six.SixNodeEntity, side: Direction, descriptor: org.ja13.eau.node.six.SixNodeDescriptor) :
...
class PIDRegulatorGui(val render: PIDRegulatorRender) : org.ja13.eau.gui.GuiScreenEln() {
    var KpBar: org.ja13.eau.gui.GuiVerticalTrackBar? = null
    var KiBar: org.ja13.eau.gui.GuiVerticalTrackBar? = null
    var KdBar: org.ja13.eau.gui.GuiVerticalTrackBar? = null
...
class Amplifier : AnalogFunction() {
    override val hasState = true
    override val inputCount = 1
    override val infos = org.ja13.eau.i18n.I18N.tr("An amplifier increases the voltage\nof an input signal by a configurable\ngain and outputs that voltage.")
...
class AmplifierElement(node: org.ja13.eau.node.six.SixNode, side: Direction, sixNodeDescriptor: org.ja13.eau.node.six.SixNodeDescriptor) :
    AnalogChipElement(node, side, sixNodeDescriptor), org.ja13.eau.item.IConfigurable {
...
class AmplifierRender(entity: org.ja13.eau.node.six.SixNodeEntity, side: Direction, descriptor: org.ja13.eau.node.six.SixNodeDescriptor) :
    AnalogChipRender(entity, side, descriptor) {
...
class AmplifierGui(val render: AmplifierRender) : org.ja13.eau.gui.GuiScreenEln() {
    private var gainTF: org.ja13.eau.gui.GuiTextFieldEln? = null

    override fun initGui() {
        super.initGui()

        gainTF = newGuiTextField(6, 6, 50)
        gainTF?.setComment(0, org.ja13.eau.i18n.I18N.tr("Gain"))
    ...
    override fun newHelper() = org.ja13.eau.gui.GuiHelper(this, 62, 24)
}

class VoltageControlledAmplifier : AnalogFunction() {
    override val inputCount = 2
    override val infos = org.ja13.eau.i18n.I18N.tr("A voltage-controlled amplifier (VCA)\nis an electronic amplifier that varies\nits gain depending on the control voltage.")
...
class SummingUnit : AnalogFunction() {
    ...
    override val infos = org.ja13.eau.i18n.I18N.tr("The summing unit outputs the sum of\nthe three weighted inputs.The\ngain for each input can be configured.")
...
class SummingUnitElement(node: org.ja13.eau.node.six.SixNode, side: Direction, sixNodeDescriptor: org.ja13.eau.node.six.SixNodeDescriptor) :
    AnalogChipElement(node, side, sixNodeDescriptor), org.ja13.eau.item.IConfigurable {
...
class SummingUnitRender(entity: org.ja13.eau.node.six.SixNodeEntity, side: Direction, descriptor: org.ja13.eau.node.six.SixNodeDescriptor) :
    AnalogChipRender(entity, side, descriptor) {
...
class SummingUnitGui(val render: SummingUnitRender) : org.ja13.eau.gui.GuiScreenEln() {
    private var gainTFs = arrayOfNulls<org.ja13.eau.gui.GuiTextFieldEln>(3)
    ...
    override fun initGui() {
        ...
        gainTFs[0]?.setComment(0, org.ja13.eau.i18n.I18N.tr("Gain for input \u00a741"))
        gainTFs[1]?.setComment(0, org.ja13.eau.i18n.I18N.tr("Gain for input \u00a722"))
        gainTFs[2]?.setComment(0, org.ja13.eau.i18n.I18N.tr("Gain for input \u00a713"))
    }

    override fun newHelper() = org.ja13.eau.gui.GuiHelper(this, 62, 64)
}

class SampleAndHold : AnalogFunction() {
    override val hasState = true
    override val inputCount = 2
    override val infos = org.ja13.eau.i18n.I18N.tr("Samples the voltage of a varying analog signal when\nthe clock input changes from 0 to 1 and holds its\noutput voltage at a constant level until next clock pulse.\nYou can see it as an analog D-Flipflop.")
...
class FilterElement(node: org.ja13.eau.node.six.SixNode, side: Direction, sixNodeDescriptor: org.ja13.eau.node.six.SixNodeDescriptor) :
    AnalogChipElement(node, side, sixNodeDescriptor), org.ja13.eau.item.IConfigurable {
    ...
    private var cutOffFrequency = org.ja13.eau.EAU.electricalFrequency / 4.0
...
class FilterRender(entity: org.ja13.eau.node.six.SixNodeEntity, side: Direction, descriptor: org.ja13.eau.node.six.SixNodeDescriptor) :
    AnalogChipRender(entity, side, descriptor) {
    internal var cutOffFrequency = Synchronizable(org.ja13.eau.EAU.electricalFrequency.toFloat() / 4f)
...
class FilterGui(private var render: FilterRender) : org.ja13.eau.gui.GuiScreenEln() {
    ...
    override fun preDraw(f: Float, x: Int, y: Int) {
        ...
        freq?.setComment(0, org.ja13.eau.i18n.I18N.tr("Cut-off frequency %1$ Hz",
            String.format("%1.3f", freq?.value ?: org.ja13.eau.EAU.electricalFrequency / 4f)))
    }

    override fun newHelper(): org.ja13.eau.gui.GuiHelper {
        return org.ja13.eau.gui.GuiHelper(this, 12 + 20, 12 + 50 + 4)
    }
}
